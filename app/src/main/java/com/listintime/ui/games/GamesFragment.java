...
public class GamesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        MediaType.setCurrentMediaFragment(MediaType.GAME);

        Button sortButton = root.findViewById(R.id.sortlist);
        setSortButton(sortButton);

        gamesViewModel.getLists().observe(getViewLifecycleOwner(), lists -> {
            ...
            addListDialog.setTitle("Sort by :")
                    ...
                    .setPositiveButton("Sort", (dialog, which) -> {
                        ...
                        switch (lastSortClicked){
                            case 0: gamesViewModel.sortByDate();
                                break;
                            case 1: gamesViewModel.sortByAlphabet();
                                break;
                        }
                    })
